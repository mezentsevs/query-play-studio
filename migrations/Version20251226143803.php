...
final class Version20251226143803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
                CREATE TABLE ai_conversation (
                  ...
                  INDEX IDX_D13CEF47A76ED395 (user_id),
                  PRIMARY KEY(id)
        ...
        $this->addSql(<<<'SQL'
                CREATE TABLE exercise (
                  ...
                  initial_schema LONGTEXT NOT NULL,
        ...
        $this->addSql(<<<'SQL'
                CREATE TABLE sandbox_log (
                  ...
                  INDEX IDX_3D5BFB49A76ED395 (user_id),
                  PRIMARY KEY(id)
                ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
            SQL);
        ...
        $this->addSql(<<<'SQL'
                CREATE TABLE user_exercise_progress (
                  ...
                  user_query LONGTEXT DEFAULT NULL,
                  started_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)',
                  completed_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)',
                  attempts INT DEFAULT NULL,
                  score DOUBLE PRECISION DEFAULT NULL,
                  INDEX IDX_DC72E985A76ED395 (user_id),
                  INDEX IDX_DC72E985E934951A (exercise_id),
                  UNIQUE INDEX uniq_user_exercise (user_id, exercise_id),
                  PRIMARY KEY(id)
                ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
            SQL);
        ...
        $this->addSql(<<<'SQL'
                ALTER TABLE
                  ai_conversation
                ADD
                  CONSTRAINT FK_D13CEF47A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE
            SQL);
        ...
        $this->addSql(<<<'SQL'
                ALTER TABLE
                  sandbox_log
                ADD
                  CONSTRAINT FK_3D5BFB49A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE
            SQL);
        ...
        $this->addSql(<<<'SQL'
                ...
                ADD
                  CONSTRAINT FK_DC72E985A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE
            SQL);
        ...
        $this->addSql(<<<'SQL'
                ALTER TABLE
                  user_exercise_progress
                ADD
                  CONSTRAINT FK_DC72E985E934951A FOREIGN KEY (exercise_id) REFERENCES exercise (id) ON DELETE CASCADE
            SQL);
    }
